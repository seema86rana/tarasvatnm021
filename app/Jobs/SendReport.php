...
class SendReport implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(int $userId, string $filter, string $previousDay, string $currentDay, string $emailSubjectLabel, string $pdfFilePath)
    {
    ...
    {
        try {
            $this->sendReports($this->userId, $this->filter, $this->previousDay, $this->currentDay, $this->emailSubjectLabel, $this->pdfFilePath);
    ...
    public function sendReports($userId, $filter, $previousDay, $currentDay, $emailSubjectLabel, $pdfFilePath)
    {
