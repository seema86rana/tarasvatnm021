...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">User's list</h5>
        <div class="heading-elements">
            <button class="btn btn-theme-dark btn-labeled add-user">
                <b><i class="icon-plus-circle2"></i></b> Add User
            </button>
    ...
    <div class="panel-body table-responsive">
        <table class="table table-bordered table-striped datatable-scroller users-dt" id="users-dt">
            <thead>
                <tr>
                    <th>Serial No.</th>
                    <th>User Name</th>
...
<script type="text/javascript" src="{{ asset('assets/backend/js/custom/users.js') }}"></script>
